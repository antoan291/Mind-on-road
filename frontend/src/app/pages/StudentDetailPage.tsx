...
import { 
  Edit, Phone, Mail, User, Calendar, MapPin, 
  BookOpen, Car, DollarSign, FileText, Bell, 
  CheckCircle, Clock, AlertCircle, Download, MessageSquare,
  ...
  const notes = [
    {
      ...
      type: 'Инструктор',
      content: 'Курсистът показва отлични резултати. Готов за по-сложни маневри.',
      important: false,
    },
    {
      id: 2,
      ...
      type: 'Администратор',
      content: 'Родителят се обади да запита за напредъка. Изпратена информация по email.',
      important: false,
    },
    {
      id: 3,
      ...
      author: 'Георги Петров',
      type: 'Инструктор',
      content: 'Препоръчвам допълнителни часове за паркиране след достигане на 15 часа.',
      important: true,
    },
  ];
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button variant="primary" icon={<Edit size={18} />} onClick={() => navigate(`/students/${id}/edit`)}>
              Редактирай
            </Button>
          </>
        }
      ...
      <div className="p-6 lg:p-8">
        <div className="rounded-xl p-6 mb-6" style={{ background: 'var(--bg-card)' }}>
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Contact */}
              <div>
                <h4 className="text-sm mb-3" style={{ color: 'var(--text-tertiary)' }}>
                  Контакт
                </h4>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span style={{ color: 'var(--text-secondary)' }}>{student.address}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span style={{ color: 'var(--text-secondary)' }}>Категория {student.category}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span style={{ color: 'var(--text-secondary)' }}>Начало: {student.startDate}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-3">
                  <div className="flex items-center justify-between mb-2 text-sm">
                    ...
                    <span className="font-semibold" style={{ color: 'var(--text-primary)' }}>{student.progress}%</span>
                  </div>
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="p-6">
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <LessonStat
                    ...
                    icon={<DollarSign size={18} style={{ color: 'var(--status-success)' }} />}
                  />
                  <LessonStat
                    label="Проведени"
                    value={student.usedLessons}
                    icon={<CheckCircle size={18} style={{ color: 'var(--primary-accent)' }} />}
                  />
                  <LessonStat
                    label="Остават"
                    value={student.remainingLessons}
                    icon={<Clock size={18} style={{ color: 'var(--text-secondary)' }} />}
                  />
                </div>

                <div className="p-4 rounded-lg" style={{ background: 'var(--bg-panel)' }}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Използвани часове</span>
              ...
              <div className="p-6">
                <div className="mb-4">
                  ...
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
                    Присъствие: {student.theoryAttendance} / {student.theoryTotal} занятия
                  </p>
                </div>

                <div className="p-4 rounded-lg mb-4" style={{ background: 'var(--bg-panel)' }}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Посетени занятия</span>
                    <span className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
            ...
            <div className="rounded-xl" style={{ background: 'var(--bg-card)' }}>
              <div className="p-6 border-b" style={{ borderColor: 'var(--ghost-border)' }}>
                <h3 style={{ color: 'var(--text-primary)' }}>Родител / Настойник</h3>
              </div>
              <div className="p-6 space-y-3">
                <InfoRow icon={<User size={16} />} label="Име" value={student.parentName} />
                <InfoRow icon={<Phone size={16} />} label="Телефон" value={student.parentPhone} />
                <InfoRow icon={<Mail size={16} />} label="Email" value={student.parentEmail} />
              </div>
            </div>
            ...
            <div className="rounded-xl" style={{ background: 'var(--bg-card)' }}>
              <div className="p-6 border-b" style={{ borderColor: 'var(--ghost-border)' }}>
                <h3 style={{ color: 'var(--text-primary)' }}>Последна активност</h3>
              </div>
              <div className="p-6 space-y-3">
                {lessons.slice(0, 3).map((lesson) => (
                  <div key={lesson.id} className="p-3 rounded-lg" style={{ background: 'var(--bg-panel)' }}>
          ...
          <div className="rounded-xl" style={{ background: 'var(--bg-card)' }}>
            <div className="p-6 border-b" style={{ borderColor: 'var(--ghost-border)' }}>
              <div className="flex items-center justify-between">
                <h3 style={{ color: 'var(--text-primary)' }}>История на практиката</h3>
                ...
                columns={[
                  {
                    ...
                    render: (value: string, row: any) => (
                      <div>
                        ...
                        <div className="text-xs" style={{ color: 'var(--text-tertiary)' }}>{row.time}</div>
                      </div>
                    ),
                  },
                  { key: 'type', label: 'Тип' },
        ...
        {activeTab === 'payments' && (
          <div className="rounded-xl" style={{ background: 'var(--bg-card)' }}>
            <div className="p-6 border-b" style={{ borderColor: 'var(--ghost-border)' }}>
              <div className="flex items-center justify-between">
                <h3 style={{ color: 'var(--text-primary)' }}>История на плащанията</h3>
        ...
        {activeTab === 'documents' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="rounded-xl" style={{ background: 'var(--bg-card)' }}>
              ...
              <div className="p-6 space-y-3">
                {documents.map((doc) => (
                  <div key={doc.id} className="p-4 rounded-lg" style={{ background: 'var(--bg-panel)' }}>
            ...
            <div className="rounded-xl" style={{ background: 'var(--bg-card)' }}>
              ...
              <div className="p-6">
                <div 
                  ...
                  style={{ borderColor: 'var(--ghost-border-medium)', minHeight: '200px' }}
                >
                  <ImageIcon size={48} style={{ color: 'var(--text-dim)' }} className="mb-3" />
        ...
        {activeTab === 'notifications' && (
          <div className="rounded-xl" style={{ background: 'var(--bg-card)' }}>
            <div className="p-6 border-b" style={{ borderColor: 'var(--ghost-border)' }}>
              <h3 style={{ color: 'var(--text-primary)' }}>Известия и сигнали</h3>
            </div>
            <div className="p-6 space-y-3">
              {notifications.map((notif) => {
                ...
                const icon = iconMap[notif.type as keyof typeof iconMap] || <Bell size={20} />;

                return (
                  <div key={notif.id} className="p-4 rounded-lg" style={{ background: 'var(--bg-panel)' }}>
...
// Helper Components
function LessonStat({ label, value, icon }: { label: string; value: number; icon: React.ReactNode }) {
  return (
