...
This repo is a strong practical reference for Node.js architecture, error handling, code style, testing, production readiness, and security.
It does not replace our architecture, but it serves as a permanent backend quality standard.
