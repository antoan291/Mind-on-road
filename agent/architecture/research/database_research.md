...
These notes collect stable principles for designing databases for SaaS products with PostgreSQL, multi-tenant modeling, sensitive documents, and long-term maintainability.
