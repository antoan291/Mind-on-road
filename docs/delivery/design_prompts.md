# Stitch Prompts for MindOnRoad

## Purpose of this file

This file contains ready-to-use prompts for Stitch to design the full MindOnRoad system. The prompts are written to reduce common Stitch problems:
...
```text
Create a complete design system for a web-based driving school management platform called MindOnRoad.
...
```text
Use the already established design system and create the main desktop architecture for the MindOnRoad admin platform.
...
```text
Use the same design system and the same visual language from the desktop version of MindOnRoad and create the mobile version of the product.
...
```text
Use the established MindOnRoad template and create a desktop admin dashboard.
...
```text
Use the established template and create the desktop screen for the Payments Table in MindOnRoad.
...
```text
Use the established template and create the desktop screen for the Invoices page in MindOnRoad.
...
```text
Use the established template and create the desktop page for the Practical Lessons module in MindOnRoad.
...
```text
Use the established template and create the desktop page for the Theory module in MindOnRoad.
...
```text
Use the established template and create the desktop page for the Instructors module in MindOnRoad.
...
```text
Use the established template and create the desktop Schedule page for MindOnRoad.
...
```text
Review all screens created so far for MindOnRoad and unify them into one fully consistent design system.
