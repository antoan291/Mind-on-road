...
The legacy workbooks [register-silvi-ins.xlsx](../artifacts/otcheti/register-silvi-ins.xlsx) and [otchet-vili.xlsx](../artifacts/otcheti/otchet-vili.xlsx) revealed additional required structures.

They are reconciled in [legacy_school_data_reconciliation.md](legacy_school_data_reconciliation.md), but the database consequence is explicit here.
