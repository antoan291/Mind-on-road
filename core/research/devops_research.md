...
Тези бележки фиксират DevOps принципи, които трябва да се прилагат при проектиране, деплой, наблюдение, recovery и operational discipline за SaaS продукти.
